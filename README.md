...
- CSS – Clean and intuitive styling  

### Backend
- AWS Lambda – Serverless compute for handling business logic  
- Amazon API Gateway – RESTful API endpoints  
- Amazon DynamoDB – Fast, scalable NoSQL database  
- Amazon Cognito – Secure authentication and authorization  

### Deployment & DevOps
- Amazon S3 & CloudFront – Static hosting + CDN delivery  
...
Contributions are welcome! If you'd like to report issues, request features, or contribute improvements, please follow these steps:
